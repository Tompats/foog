...
export const trips: Trip[] = [
  ...
  },
  {
    ...
    title: 'Χειμερινό Camp Σχολής Σκι στο Μπόροβετς',
    ...
    leader: 'Αναστασία Παπαδοπούλου',
    status: 'active',
    shortDescription: 'Τριήμερο camp της σχολής σκι του ομίλου στο χιονοδρομικό του Μπόροβετς στη Βουλγαρία, με μαθήματα για παιδιά και ενήλικες σε σκι και snowboard.',
    location: 'Χιονοδρομικό Μπόροβετς, Βουλγαρία',
    activities: ['Μαθήματα σκι για αρχάριους', 'Μαθήματα snowboard για junior αθλητές', 'Παιχνίδια στο χιόνι & ομαδική φωτογραφία'],
    gear: ['Σκι ή snowboard εξοπλισμός', 'Κράνος & γυαλιά χιονιού', 'Αδιάβροχη φόρμα σκι', 'Θερμικά ρούχα', 'Γάντια σκι', 'Διαβατήριο / ταυτότητα'],
    itinerary: [
      {
        label: 'Ημέρα 1',
        entries: ['Αναχώρηση από τα Γιαννιτσά και άφιξη στο χιονοδρομικό Μπόροβετς', 'Τακτοποίηση και χωρισμός σε ομάδες επιπέδου', 'Βραδινή βόλτα στο θέρετρο']
      },
      {
        label: 'Ημέρα 2',
        entries: ['Μαθήματα σκι και snowboard στις πλαγιές', 'Βραδινό παιχνίδι στο χιόνι με χιονάγγελους']
      },
      {
        label: 'Ημέρα 3',
  ...
  {
    slug: 'paiko-braduni-pezoporia-panselinos-2026',
    title: 'Βραδυνή Πεζοπορία με Πανσέληνο στο Πάικο',
    ...
    leader: 'Αναστασία Παπαδοπούλου',
    status: 'active',
    shortDescription: 'Βραδυνή πεζοπορία στο Πάικο παρέα με την πανσέληνο, μέσω του δασικού δρόμου ως τη θέση "Παρά Πέντε". Εύκολη διαδρομή, κατάλληλη και για μικρά παιδιά, ανοιχτή σε μέλη και φίλους του συλλόγου.',
    location: 'Ελευθεροχώρι (κεραίες), Πάικο, Πέλλα',
    activities: ['Βραδυνή πεζοπορία με φως πανσελήνου', 'Διαδρομή μέσω δασικού δρόμου προς τη θέση "Παρά Πέντε"', 'Κέρασμα από τον σύλλογο στον προορισμό'],
    gear: ['Φακός κεφαλής ή χεριού', 'Λεπτό μπουφάν', 'Νερό για τη διαδρομή', 'Καλή διάθεση'],
    itinerary: [
      {
        label: 'Ημέρα 1',
        entries: ['Συνάντηση στο Ελευθεροχώρι (κεραίες)', 'Αναχώρηση στις 19:00 μέσω του δασικού δρόμου', 'Άφιξη στη θέση "Παρά Πέντε" με κέρασμα από τον σύλλογο']
      }
    ]
  },
  {
...
export const tripTranslations: Record<string, TripTranslation> = {
  ...
  'cheimerino-camp-ski-voras-2026': {
    title: 'Winter Ski School Camp in Borovets',
    shortDescription:
      "A three-day camp run by the club's ski school at the Borovets ski resort in Bulgaria, with ski and snowboard lessons for both children and adults.",
    location: 'Borovets Ski Resort, Bulgaria',
    activities: [
    ...
    itinerary: [
      {
        label: 'Day 1',
        entries: [
          'Departure from Giannitsa and arrival at the Borovets ski resort',
          'Check-in and split into level groups',
          'Evening stroll around the resort',
        ],
      },
      {
        label: 'Day 2',
  ...
  'paiko-braduni-pezoporia-panselinos-2026': {
    ...
    activities: [
      ...
      'Route via the forest road to the "Para Pente" spot',
      'Refreshments from the club at the destination',
    ],
    gear: [
      'Head or hand torch',
      'Light jacket',
    ...
    itinerary: [
      {
        label: 'Day 1',
        entries: [
          'Meet at Eleftherochori (antennas)',
          'Departure at 19:00 via the forest road',
          'Arrival at the "Para Pente" spot with refreshments from the club',
        ],
      },
    ],
  },
