...
export const trips: Trip[] = [
  {
    ...
    elevationGain: 1200,
    distanceKm: 14,
    leader: 'Δήμητρα Χατζηγεωργίου',
    status: 'active',
    shortDescription: 'Ski touring στην κορυφογραμμή Παρνασσού με φώκιες και powder κατάβαση προς Καρπενήσι.',
  ...
  },
  {
    ...
    elevationGain: 1800,
    distanceKm: 18,
    leader: 'Λάζαρος Νικολάου',
    status: 'active',
    shortDescription: 'Αλπικό νυχτερινό push στον Μύτικα Ολύμπου με μικτό πεδίο, στάση στα Πριόνια και ανατολή πάνω από τις κορυφές Σκολιό και Λαιμός.',
  ...
  },
  {
    ...
    elevationGain: 900,
    distanceKm: 16,
    leader: 'Πηνελόπη Ανδρεάδου',
    status: 'active',
    shortDescription: 'Πεζοπορία στο μονοπάτι Μακρυνόρεμα Πηλίου με ήπιες κλίσεις, τρεχούμενα νερά και θέα στον Παγασητικό.',
  ...
  },
  {
    ...
    elevationGain: 500,
    distanceKm: 6,
    leader: 'Σοφία Παπαδοπούλου',
    status: 'active',
    shortDescription: 'Μέντορινγκ πάνω στους πύργους Δούπι των Μετεώρων με multi-pitch ασκήσεις.',
