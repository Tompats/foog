...
activities:
  ...
  - Διαδρομή μέσω δασικού δρόμου προς τη θέση "Παρά Πέντε"
  - Κέρασμα από τον σύλλογο στον προορισμό
gear:
  - Φακός κεφαλής ή χεριού
  - Λεπτό μπουφάν
  - Νερό για τη διαδρομή
  - Καλή διάθεση
itinerary:
  - label: Ημέρα 1
    entries:
      - Συνάντηση στο Ελευθεροχώρι (κεραίες)
      - Αναχώρηση στις 19:00 μέσω του δασικού δρόμου
